    ...
    public void hook() throws Throwable {
        ...
        XposedHelpers.findAndHookMethod(DebugFragment, onCreate_MethodName, new XC_MethodReplacement() {
            ...
            protected Object replaceHookedMethod(MethodHookParam param) throws Throwable {
                ...
                Object switch_copy_unlock = findPreference.invoke(thisObject, "switch_copy_unlock");
                ...
                setOnPreferenceClickListener.invoke(switch_copy_unlock, thisObject);
                ...
                setIcon.invoke(switch_copy_unlock, Helper.modRes.getDrawable(R.drawable.ic_notes));
